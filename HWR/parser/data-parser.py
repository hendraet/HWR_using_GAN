...
with open('../RWTH_partition/RWTH.iam_word_gt_final.test.thresh', 'r') as f_ocr:
...
with open('/home/padl21t1/research-GANwriting/Groundtruth/gan.iam.test.gt.filter27', 'r') as f_gan:
...
for w in writers:
    images = df_gan[df_gan[1] == str(w)]

    with open('GAN_test_{}.filter27'.format(w), 'w') as f:
        i = 0
    ...
    with open('OCR_test_{}.filter27'.format(w), 'w') as f:
        i = 0
        for index, image in images.iterrows():
