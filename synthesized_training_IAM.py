...
parser.add_argument('--writer', type=str, help='Specify which IAM writer should be trained.')
...
# create images
create_imgs_from_IAM.create_images_of_writer(writer, args.n_generated_images, config.data_dir, config.gan_default_model)
...
train_with_synth_imgs.train_and_test_with_synthesized_imgs(writer, args.n_generated_images, labels_file, synthesized_img_path)
